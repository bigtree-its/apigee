 ...
 *  */
 ...
 if (context.getVariable("request.queryparam.redirect_uri_not_allowed"))
 {
  context.setVariable("redirectURIs", context.getVariable("request.queryparam.redirect_uri_not_allowed"));
 } 
 else {
