...
var the_access_token = context.getVariable("oauthv2accesstoken." + executedOAuthV2PolicyName + ".access_token");
var access_token_scope = context.getVariable("oauthv2accesstoken." + executedOAuthV2PolicyName + ".scope");
var access_token_expires_in = context.getVariable("oauthv2accesstoken." + executedOAuthV2PolicyName + ".expires_in");
var the_refresh_token = context.getVariable("oauthv2accesstoken." + executedOAuthV2PolicyName + ".refresh_token");
var d = new Date();
...
context.setVariable("accessTokenScope", access_token_scope);

const access_token_scope_array = access_token_scope.split(" ");
context.setVariable("accessTokenScopeArray", JSON.stringify(access_token_scope_array));