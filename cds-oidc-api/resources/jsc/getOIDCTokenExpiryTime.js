...
var tokenExpiryTime = context.getVariable("CDS.authTokenExpiresMilliSecs"); //String(context.getVariable("OIDCTokenResponse.expires_in")) + "000";
...
context.setVariable("CDS.refreshTokenExpiryTimeInMillis", refreshTokenExpiryTime);

// Get sharing_expires_at is the same as refresh_token_expires_at.
// Consider if wanted a shorter refresh token, but would force ADR to refresh tokens via a background task.